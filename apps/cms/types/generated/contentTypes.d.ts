...
export interface ApiBusinessPartnersPageBusinessPartnersPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    caseStudies: Schema.Attribute.Component<'business-partners.case-studies-section', false> &
    ...
    introduction: Schema.Attribute.Component<'business-partners.introduction-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sector: Schema.Attribute.Enumeration<['residential', 'industrial', 'medical', 'retail']> &
      Schema.Attribute.Required;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    testimonials: Schema.Attribute.Component<'business-partners.testimonials-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBusinessPartnersBusinessPartners extends Struct.SingleTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.Component<'business.partnership-categories', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    >;
    philosophy: Schema.Attribute.Component<'business.partnership-philosophy', false>;
    ...
    successStories: Schema.Attribute.Component<'business.success-stories', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiContactFormConfigContactFormConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global configuration for contact forms with internationalization';
  ...
  attributes: {
    contactForm: Schema.Attribute.Component<'forms.contact-form-builder', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    recaptchaScore: Schema.Attribute.Float;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact page content and configuration';
  ...
  attributes: {
    ...
    Map: Schema.Attribute.Component<'contact.map-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    SalesTeam: Schema.Attribute.Component<'contact.sales-team', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    navigation: Schema.Attribute.Component<'footer.link-group', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    newsletter: Schema.Attribute.Component<'footer.newsletter', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiJotunPageJotunPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    FeaturedProducts: Schema.Attribute.Component<'jotun.featured-products', false>;
    Hero: Schema.Attribute.Component<'jotun.hero', false>;
    Introduction: Schema.Attribute.Component<'jotun.introduction', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::jotun-page.jotun-page'> &
      Schema.Attribute.Private;
    ProductCategories: Schema.Attribute.Component<'jotun.product-categories', false>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiProjectsPortfolioProjectsPortfolio extends Struct.SingleTypeSchema {
  collectionName: 'projects_portfolios';
  info: {
    description: 'Projects Portfolio page content with filtering and project showcase';
    displayName: 'Projects Portfolio';
    pluralName: 'projects-portfolios';
    singularName: 'projects-portfolio';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'portfolio.cta-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    hero: Schema.Attribute.Component<'portfolio.hero-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    projects: Schema.Attribute.Component<'portfolio.project-card', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual service pages with detailed information';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    benefitsSection: Schema.Attribute.Component<'services.benefits-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ctaSection: Schema.Attribute.Component<'services.cta-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    features: Schema.Attribute.Component<'services.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    gallerySection: Schema.Attribute.Component<'services.gallery-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    processCta: Schema.Attribute.Component<'services.process-cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Main services page content and structure';
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'services.cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::projects-portfolio.projects-portfolio': ApiProjectsPortfolioProjectsPortfolio;
