          ...
          <div className="flex h-full">
            <div className="w-1/2 relative">
              <Image
                ...
                alt={splitImages.leftImage.alternativeText || splitImages.leftImageAlt || 'Residential'}
                fill
            ...
            <div className="w-1/2 relative">
              <Image
                ...
                alt={splitImages.rightImage.alternativeText || splitImages.rightImageAlt || 'Commercial'}
                fill
                className="object-cover"
                priority
              />
