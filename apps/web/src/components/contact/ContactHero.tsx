  ...
  return (
    <section className="relative py-32 bg-gradient-to-br from-orange-500 to-orange-600 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-20 w-60 h-60 bg-white/5 rounded-full blur-2xl animate-pulse"
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-32 h-32 bg-white/10 rounded-lg rotate-45 blur-lg animate-pulse"
      ...
      <div className="absolute bottom-0 left-0 right-0 transform scale-y-[-1]">
