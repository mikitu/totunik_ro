    ...
    <section className="py-20 bg-gray-100">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">{mapSection.title}</h2>
          {mapSection.subtitle && (
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{mapSection.subtitle}</p>
          )}
        </div>
                ...
                <div className="relative h-96 bg-gray-200 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      Click to load the interactive map and get directions
                    </p>
                    <button
