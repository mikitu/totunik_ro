    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">{salesTeam.title}</h2>
          {salesTeam.subtitle && (
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{salesTeam.subtitle}</p>
          )}
        </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-orange-50 rounded-lg p-8 max-w-2xl mx-auto">
              ...
              {salesTeam.emergencyContact.description && (
                <p className="text-gray-600 mb-6">{salesTeam.emergencyContact.description}</p>
              )}
