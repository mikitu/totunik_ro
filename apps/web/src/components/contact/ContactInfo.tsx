  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {contactInfo.subtitle && <p className="text-xl text-gray-600">{contactInfo.subtitle}</p>}
      </div>
                  ...
                  {method.type === 'fax' && (
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2M7 4h10M7 4l-2 14h14l-2-14M11 9h2M9 12h6M10 15h4"
                      />
                    </svg>
                  )}
                  {method.type === 'website' && (
              ...
              <div>
                ...
                <div className="text-gray-600 space-y-1">
                  ...
                  {contactInfo.businessHours.saturdayHours && (
                    <p>{contactInfo.businessHours.saturdayHours}</p>
                  )}
                  {contactInfo.businessHours.sundayHours && (
                    <p>{contactInfo.businessHours.sundayHours}</p>
                  )}
      ...
      {contactInfo.companyDetails && (
        <div className="bg-gray-100 rounded-lg p-6">
          ...
          <div className="text-gray-600 space-y-1">
            <p>
              <strong>{contactInfo.companyDetails.companyName}</strong>
            </p>
            {contactInfo.companyDetails.taxCode && (
              <p>Tax Code: {contactInfo.companyDetails.taxCode}</p>
            )}
            {contactInfo.companyDetails.registrationNumber && (
              <p>Registration: {contactInfo.companyDetails.registrationNumber}</p>
            )}
            {contactInfo.companyDetails.vatNumber && (
              <p>VAT: {contactInfo.companyDetails.vatNumber}</p>
            )}
